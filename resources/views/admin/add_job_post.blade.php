        ...
        @csrf
            ...
            <div class="form-row row">
              ...
              <div class="form-group col-md-3 category-modal">
                ...
                <div class="add-category">
                  <a  data-bs-toggle="modal" data-bs-target="#add_region" onclick="setLocalStorage()">
                    <img src="{{asset('images/icons/plus.svg')}}" alt="">
                  </a>
                </div>
              </div>              
...
<!-- Add region Modal -->
<div class="modal fade" id="add_region" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <form action="{{route('admin.add_region')}}" method="post">
        @csrf
      <div class="modal-body">
        <input type="text" name="region" class="form-control"  aria-describedby="emailHelp" placeholder="Example : Dar es Salaam">
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <button type="submit" class="btn btn-primary">Confirm</button>
